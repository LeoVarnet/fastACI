function publ_osses2025_fig5(varargin)
% function publ_osses2025_fig5()
%
% % To display Fig. 5 of Osses et al use :
%     publ_osses2025_fig5()
%
% Results obtained for the 4 participants in the 11.8-dB condition (SNR matched with AMS75).
...
definput.flags.type={'fig2','missingflag','fig1','fig3','fig4A','fig4B','fig5A','fig5B'};
...
%% fig3. and Fig 3. Ahumada's like ACIs for the two groups
        ...
        hfig2 = figure('Position', [10,10,750,250]);
        ...
        for i_subject = 1:N_subjects
            ...
            % ACI-like display
            affichage_tf(ACI_matrix(:,:,i_subject),'CI', 'cfg', cfg_ACI, 'colorbar_map', cmap, 'NfrequencyTicks', 5); hold on
            ...
            set(gca,'YTickLabel',{'400', '450', '500', '550', '600'});
