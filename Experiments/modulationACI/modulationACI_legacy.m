function cfg_inout = modulationACI_legacy(cfg_inout,bShow)
% function cfg_crea = modulationACI_legacy(cfg_crea,bShow)
%
...
if ~isfield(cfg_inout,'dir_noise')
    cfg_inout.dir_noise = [cfg_inout.dir_data_experiment cfg_inout.Subject_ID filesep cfg_inout.folder_name filesep];
    fields_updated{end+1} = sprintf('\tdir_noise assigned (added on %s)',date_changed);
end
