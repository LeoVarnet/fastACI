function [str_stim,data_passation] = modulationFM_user(cfg,data_passation)
% function [str_stim,data_passation] = modulationFM_user(cfg,data_passation)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dur  = cfg.stim_dur;
fs   = cfg.fs;
fdev = data_passation.expvar(i_current); % Frequency deviation delta f
...
signal = create_FM_tone(fc, fmod, fdev*istarget, dur, fs)';
