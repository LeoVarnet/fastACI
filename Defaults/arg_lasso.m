function definput = arg_lasso(definput)
% function definput = arg_lasso(definput)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

definput.keyvals.lasso_Nlevel = 5; % 5 is the default
...
%         
%         Nlevel    = 4; warning('temporally set to 4'); % 5; % number of levels (= degrees of filtering) in the Gaussian pyramid
