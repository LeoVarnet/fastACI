...
cMap = [ ...
    ...
    cMap = [ [ linspace(0,1,N_steps)' ; linspace(1,max_colour_val,N_steps)'] ,...
             ...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)' ] ];
    
    case {'DG_blue_red'}
    max_colour_val = 0.5; 
    N_steps = 128;
    cMap = [ [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)' ] ,...
             [ linspace(0,1,N_steps)' ; linspace(1,0,N_steps)' ] ,...
             [ linspace(0,1,N_steps)' ; linspace(1,max_colour_val,N_steps)']];  
    ...
    max_colour_val = 0.5; 
    N_steps = 128;
    cMap = [ [ linspace(0,1,N_steps)' ; linspace(1,0,N_steps)' ] ,...
             [ linspace(0,1,N_steps)' ; linspace(1,max_colour_val,N_steps)'] ,...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)' ]];  
    ...
    max_colour_val = 0.5; 
    N_steps = 128;
    cMap = [ [ linspace(0,1,N_steps)' ; linspace(1,0.5,N_steps)' ] ,...
             [ linspace(0,1,N_steps)' ; linspace(1,max_colour_val,N_steps)'] ,...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)' ]];  
    ...
    max_colour_val = 0.5; 
    N_steps = 128;
    cMap = [ [ linspace(0.5,1,N_steps)' ; linspace(1,0,N_steps)' ] ,... 
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)' ],...
             [ linspace(0,1,N_steps)' ; linspace(1,max_colour_val,N_steps)']];
    ...
    cMap = [ [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)'] ,...
             [ linspace(0,1,N_steps)' ; linspace(1,0,N_steps)' ] ,...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0.5,N_steps)' ]];  
    ...
    N_steps = 128;
    cMap = [ [ linspace(0,1,N_steps)' ; linspace(1,0.5,N_steps)' ] ,...
             [ linspace(0.5,1,N_steps)' ; linspace(1,max_colour_val,N_steps)'] ,...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)' ]];  
    ...
    N_steps = 128;
    cMap = [ [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0,N_steps)'] ,...
             [ linspace(0,1,N_steps)' ; linspace(1,0.5,N_steps)' ] ,...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0.5,N_steps)' ]];  
    ...
    N_steps = 128;
    cMap = [ [ linspace(0,1,N_steps)' ; linspace(1,max_colour_val,N_steps)'] ,...
             [ linspace(0.5,1,N_steps)' ; linspace(1,0,N_steps)' ] ,...
             [ linspace(max_colour_val,1,N_steps)' ; linspace(1,0.5,N_steps)' ]];  
