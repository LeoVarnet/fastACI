function files_out = Get_f0_from_dir(folder, params)
...
params = Ensure_field(params,'pitchfloor'  , 100); % positive pitchfloor 100
params = Ensure_field(params,'pitchceiling', 500); % positive pitchfloor 100
...
for i = 1:length(files_wav)
	files_out{i} = [files_wav{i}(1:end-4) '_f0.txt'];
