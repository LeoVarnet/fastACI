...
% function data = publ_osses2022b_JASA_figs(varargin)
%
% 1. Description: This script is obsolete but still operative. The related
%      journal publication is now named publ_osses2022c_JASA_figs, and the 
%      equivalent version for this file is now named publ_osses2022b_bioRxiv_figs.
%
...
%     publ_osses2022b_JASA_figs('fig6'); %  Experimental ACIs for each participant and for the group
%
...
% See also: publ_osses2022b_bioRxiv_figs.m, g20220716_get_paper_figures_JASA_ACI.m (from fastACI_sim)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
data = publ_osses2022b_bioRxiv_figs(varargin{:});
